...
imp ""
imp "JNI is not on by default for Oracle's JDK. You have to enable JNI by editing:"
imp "    /Library/Java/JavaVirtualMachines/jdk*.jdk/Contents/Info.plist"
imp "and add the following to the configuration (search for 'JVMCapabilities'):"
imp "    <key>JVMCapabilities</key>"
imp "    <array>"
imp "        ..."
imp "        <string>JNI</string>"
imp "    </array>"
imp ""
inf
